...
Il calcolo completo viene eseguito in un Web Worker modulare, così gli input e la navigazione restano reattivi anche sugli orizzonti lunghi. Ogni nuovo input termina il calcolo precedente e soltanto l'ultima richiesta può aggiornare i risultati; i browser privi di supporto ai module worker usano lo stesso modello sul thread principale come fallback.
